...
def create_person_edit_row(label, value, input_type='text'):
    return dbc.Row([
        dbc.Col(
        ...
        dbc.Col(
            dbc.Input(value=value, placeholder=value, className="text-center", type=input_type, id=f"dashboard-edit-{label}",
                      style={
                          'font-size': '1rem',
...
def dashboard_person_edit_layout():
    return html.Div([
        html.Div(id='hidden-div-dashboard-edit', style={'display': 'none'}),
        html.Div(id='hidden-div-dashboard-delete', style={'display': 'none'}),
        ...
        dbc.Container([
            ...
            dbc.Row([
                ...
                # create_detail_row("성명", "김철수"),
                # create_detail_row("성별", "남"),
                # create_detail_row("생년월일", "0000년 00월 00일"),
                # create_detail_row("위치", "경기도 성남시 복정동"),

                dbc.Row(className='mt-3 p-0 align-items-center', id="dashboard-detail-edit-row",
                ...
                dbc.Col(
                    [
                        dbc.Button("저장",
                                   id='dashboard-edit-save-button', n_clicks=0,
                        ...
                        dbc.Button("삭제",
                                   id='dashboard-edit-delete-button', n_clicks=0,
                                   href="/admin/dashboard",
                                   className="detail_device_button align-items-center justify-content-center text-center d-flex",
                                   style={'font-size': '1rem', 'width': '30%', 'margin-left': '10px'}),
                        dbc.Button("뒤로가기", href="/admin/dashboard/detail/info",
                                   className="detail_device_button align-items-center justify-content-center text-center d-flex",
                                   style={'font-size': '1rem', 'width': '30%', 'margin-left': '10px'}),
