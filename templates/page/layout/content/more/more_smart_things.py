    ...
    layout = html.Div([
        ...
        dbc.Container([
            dcc.Loading(
                id="loading-spinner",
                type="circle",
                children=html.Div(children=more_smart_things_content(),
                                  id='main-content',
...
def more_smart_things_content():
    content = html.Div([
        html.Div(id="more-smart-things-content"),
