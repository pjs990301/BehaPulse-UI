    ...
    layout = html.Div([
        ...
        dbc.Container([
            dcc.Loading(
                id="loading-spinner",
                type="circle",
                children=html.Div(children=more_sensitivity_content(), 
                                  id='main-content', 
    ...
    content = html.Div([
        ...
        html.Div([
            html.Div([
                ...
                dcc.Slider(id='more-sensitivity-lying-slider',
                           min=0.5,
                           max=1.5,
                           value=1,
        ...
        html.Div([
            html.Div([
                ...
                dcc.Slider(id='more-sensitivity-empty-slider',
                           min=0.5,
                           max=1.5,
                           value=1,
                           marks={0.5: '', 1.5: ''},  # 빈 공간으로 양쪽 마크
        ...
        html.Div([
            html.Div([
                ...
                dcc.Slider(id='more-sensitivity-sitting-slider',
                           min=0.5,
                           max=1.5,
                           value=1,
                           marks={0.5: '', 1.5: ''},  # 빈 공간으로 양쪽 마크
        ...
        dbc.Row(
                dbc.Button("저장하기",
                           id='more-sensitivity-save-button',
                           style={
